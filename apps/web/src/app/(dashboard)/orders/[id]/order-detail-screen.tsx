 ...
 *
 * File RIÊNG khỏi page.tsx (V14): Next production build cấm page module
 * export thêm bất kỳ gì ngoài default/metadata… — export `OrderDetailScreen`
 * từ page.tsx qua được dev + vitest nhưng VỠ `next build` (checkFields).
 */
