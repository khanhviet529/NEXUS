...
> = {
  ...
  [SEED_ROLES.TENANT_ADMIN]: [
    ...
    { code: 'stock:read', scope: 'all' },
    { code: 'stock:receive', scope: 'all' },
    { code: 'stock:issue', scope: 'all' },
    { code: 'warehouse:read', scope: 'all' },
    { code: 'warehouse:create', scope: 'all' },
    ...
    { code: 'product:import', scope: 'all' },
    { code: 'product:export', scope: 'all' },
    { code: 'customer:read', scope: 'all' },
    { code: 'customer:create', scope: 'all' },
    { code: 'customer:update', scope: 'all' },
    { code: 'customer:delete', scope: 'all' },
    { code: 'report:sales', scope: 'all' },
    { code: 'approval_authority:read', scope: 'all' },
    { code: 'approval_authority:manage', scope: 'all' },
    { code: 'webhook:manage', scope: 'all' },
  ...
  [SEED_ROLES.MANAGER]: [
    ...
    { code: 'customer:create', scope: 'all' },
    { code: 'customer:update', scope: 'all' },
    { code: 'report:sales', scope: 'descendants' },
    { code: 'approval_authority:read', scope: 'all' },
    { code: 'field:cost', scope: 'all' },
    { code: 'field:finance', scope: 'all' },
  ],
